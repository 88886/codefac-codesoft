...
drop table if exists DETALLE_VENTA_ORDEN_TRABAJO;
...
/*==============================================================*/
/* Table: DETALLE_VENTA_ORDEN_TRABAJO                           */
/*==============================================================*/
...
(
   ...
   FECHA_RECORDAR       datetime,
   ESTADO               varchar(12),
   INTERVALO_RECORDAR   int,
...
alter table CATEGORIA_TRABAJO add constraint FK_REFERENCE_43 foreign key (CODIGO_SERVICIO)
...
alter table DETALLES_SERVICIO add constraint FK_REFERENCE_47 foreign key (ID_CATEGORIA_TRABAJO)
      references CATEGORIA_TRABAJO (ID_CATEGORIA_TRABAJO) on delete restrict on update restrict;

alter table DETALLES_SERVICIO add constraint FK_REFERENCE_52 foreign key (NICK)
      references USUARIO (NICK) on delete restrict on update restrict;
...
alter table DETALLE_ORDEN_TRABAJO add constraint FK_REFERENCE_44 foreign key (ID_CATEGORIA_TRABAJO)
      references CATEGORIA_TRABAJO (ID_CATEGORIA_TRABAJO) on delete restrict on update restrict;
...
alter table ORDEN_TRABAJO add constraint FK_REFERENCE_46 foreign key (USU_EMPLEADO)
      references USUARIO (NICK) on delete restrict on update restrict;

alter table PERFIL add constraint FK_REFERENCE_45 foreign key (NICK)
      references USUARIO (NICK) on delete restrict on update restrict;
...
alter table RECORDATORIO add constraint FK_REFERENCE_55 foreign key (NICK)
      references USUARIO (NICK) on delete restrict on update restrict;
...
alter table VENTA add constraint FK_REFERENCE_53 foreign key (USUARIO_PERMISO)
      references USUARIO (NICK) on delete restrict on update restrict;
